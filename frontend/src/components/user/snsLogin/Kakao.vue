  ...
  <div id="kakao-login">
    <button>
      <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
        <g id="그룹_247" transform="translate(-237 -406)">
          <g id="구성_요소_2" transform="translate(237 406)">
            <g id="타원_6" fill="#ffd800" stroke="#eee" stroke-width="1">
              <circle cx="27.5" cy="27.5" r="27.5" stroke="none" />
              <circle cx="27.5" cy="27.5" r="27" fill="none" />
            </g>
          </g>
          <g id="kakaotalk_1_" transform="translate(254 424)">
            <path
              id="패스_288"
