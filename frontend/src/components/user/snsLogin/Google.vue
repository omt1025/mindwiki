  ...
  <div class="google-login">
    <button type="button">
      ...
      >
        ...
        <g id="그룹_248" transform="translate(-300 -406)">
          <g id="타원_6" transform="translate(300 406)" fill="#fff" stroke="#eee" stroke-width="1">
            <circle cx="27.5" cy="27.5" r="27.5" stroke="none" />
            <circle cx="27.5" cy="27.5" r="27" fill="none" />
          </g>
          <g id="Google__G__Logo" transform="translate(318 424)">
            <g id="그룹_114" clip-path="url(#clip-path)">
              <path
                id="패스_154"
            ...
            <g id="그룹_115" clip-path="url(#clip-path)">
              <path
                id="패스_156"
            ...
            <g id="그룹_116" clip-path="url(#clip-path)">
              <path
                id="패스_158"
            ...
            <g id="그룹_117" clip-path="url(#clip-path)">
              <path
                id="패스_160"
